...
Para poder realizar el análisis cargamos la librería \textit{rpart}
...
La librería rpart, por defecto, hace uso de la medida de impureza Gini con lo cual no hace falta modificar la llamada a esta para generar el árbol de decisión utilizando Gini, tal y como se pide en el enunciado.
...
Como podemos observar la clasificación utilizando la librería rpart se realiza de forma correcta. La forma de mostrar el resultado no es muy gráfica pero es correcta.
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=200px,keepaspectratio]{./imagenes/arbolVehiculos.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=200px,keepaspectratio]{./imagenes/regresion.png}
