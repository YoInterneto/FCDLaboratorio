...
<<echo=true>>= 
# Leemos los datos de la primera muetra
...
<<echo=true>>= 
plot(clasificacion, uniform=TRUE, main="Clasificación de vehículos") 
...
Para este apartado, se pide que se realice un análisis de regresión lineal a partir “muestra2.txt”.
