...
\section{Ejercicio 1 - Análisis de descipción de datos satelites.txt}  

\subsection{Introducción}
En el siguiente documento se mostrarán los resultados obtenidos de la Práctica 1 de FCD. Esta práctica tiene como objetivo 
obtener, utilizando R, los valores de las mismas magnitudes cuyo valor hemos
calculado de forma manual. Para cada ejercicio, se pide realizar:
